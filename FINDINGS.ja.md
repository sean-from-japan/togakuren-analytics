...
東京都大学サッカー連盟が公開している試合記録から、連盟のサイト自体には出ていない6つのこと。結果は2021年から、選手単位の記録は2022年からの5シーズン分です。
...
| [6](#6-クラブは5年で3階層を移動しうる) | 移動 | 2部→チャレンジリーグ→2部優勝→1部2位を5年で。 |
| [1](#1-昇格は1試合あたり勝点1を失わせ降格は半分しか戻さない) | 昇格 | **予想どおりの結果**です。向きではなく大きさのために載せています（27件中26件で−1.04）。読むなら降格が半分しか戻さない非対称性の方を。 |
