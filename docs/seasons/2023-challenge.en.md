...
2023 チャレンジリーグ. The season is over, so this document is final: the same code over the same records reproduces it exactly. Regenerate with `togakuren profiles --series "2023 チャレンジリーグ" --lang en`.
