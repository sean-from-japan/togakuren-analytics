...
*[English](SEASON_TRENDS.en.md)*

終了した全シーズンをまとめたものです。2026年より前のシーズンは終了しているため、以下の表は固定です。同じ記録に同じ処理をかければ、そのまま再現されます。集計値のみで、個人は登場しません。

2021–2026 時点の集計。生成日 2026-09-03。再生成は `togakuren trends --format md --lang ja`。
...
選手単位の記録は2022年から。2021年は結果のみのため、シュート数と決定率は少数の不完全な記録から推定せず、空欄にしています。
...
1つの部の中での、出場時間の割合と90分あたり得点。数値が低い学年は年によって異なるため、継続的な学年差ではなく世代差とみなせます。
...
| 2021 | 4部リーグ | 2022 | チャレンジリーグ | 昇格 | 0.75 | 0.80 | +0.05 |
| 2021 | 3部リーグ | 2022 | 2部リーグ | 昇格 | 2.00 | 0.55 | -1.45 |
| 2021 | 1部リーグ | 2022 | 2部リーグ | 降格 | 0.75 | 2.85 | +2.10 |
| 2021 | 3部リーグ | 2022 | 2部リーグ | 昇格 | 1.50 | 1.65 | +0.15 |
| 2021 | 4部リーグ | 2022 | チャレンジリーグ | 昇格 | 3.00 | 1.47 | -1.53 |
| 2021 | 4部リーグ | 2022 | チャレンジリーグ | 昇格 | 2.14 | 1.00 | -1.14 |
| 2021 | 1部リーグ | 2022 | 2部リーグ | 降格 | 0.38 | 2.15 | +1.77 |
| 2021 | 4部リーグ | 2022 | チャレンジリーグ | 昇格 | 0.50 | 0.00 | -0.50 |
| 2021 | 4部リーグ | 2022 | チャレンジリーグ | 昇格 | 0.75 | 0.86 | +0.11 |
| 2021 | 4部リーグ | 2022 | チャレンジリーグ | 昇格 | 2.57 | 1.47 | -1.10 |
| 2021 | 4部リーグ | 2022 | チャレンジリーグ | 昇格 | 1.71 | 0.20 | -1.51 |
...
部が変わる前のシーズンと、変わった後のシーズンの1試合あたり勝点。消化途中のシーズンには印を付け、平均からは除外しています。
...
連盟のクラブIDで追跡した、全クラブのシーズンごとの所属部。空欄は、そのシーズンにこれらのリーグにいなかったことを示します。
