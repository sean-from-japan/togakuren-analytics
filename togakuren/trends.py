...
TEXT = {
    ...
    "ja": {
        ...
        "banner": "このページは集計値のみで構成されており、選手個人の行を一切含みません。",
        "h_seasons": "シーズン一覧",
        ...
        "tier_label": "レベル{n}",
        "trajectory_note": ("縦軸は部の名前ではなくリーグの階層です。この期間は部の名前と階層が一致しません。チャレンジリーグは2022年から3層目、2025年から4層目で、部の名前が変わらないまま階層だけ動いたクラブがあります。"),
        ...
        "moves_note": ("対角線より上なら、昇降格後に1試合あたりの勝点が伸びたということです。"
                       "薄い点は消化途中のシーズンで、上の平均には入れていません。"),
        "footer": "出典: 東京都大学サッカー連盟 公開コンテンツAPI。集計値のみを掲載しています。",
    },
}
